...
# Le digo que cuando se cierre el servidor se libere instantaneamente el puerto
# Bind to the address corresponding to the main name of the host
mySocket.bind((socket.gethostname(), 1235))
# socket.gethostname(): te devuelve el nombre de la máquina
...
try:
    while True:
        ...
        recvSocket.send(b"HTTP/1.1 200 OK\r\n\r\n" +
                        ...
                        b"\r\n")
        recvSocket.close()
except KeyboardInterrupt: # KeyboardInterrupt: es el control+C
